...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n0pogoprotos/enums/poi_decoration_properties.proto\x12\x10pogoprotos.enums*\xc7\x01\n\x17POIDecorationProperties\x12\t\n\x05\x43OLOR\x10\x00\x12\x0c\n\x08POSITION\x10\x01\x12\x08\n\x04SIZE\x10\x02\x12\x08\n\x04TEXT\x10\x03\x12\n\n\x06\x41\x43TIVE\x10\x04\x12\x11\n\rSET_RAID_DATA\x10\x05\x12\x19\n\x15NEARBY_CARROT_VISIBLE\x10\x06\x12\x19\n\x15SET_LOWEST_MOTIVATION\x10\x07\x12\x1a\n\x16SET_NPC_CLICKED_ACTION\x10\x08\x12\x0e\n\nBEGIN_EXIT\x10\tb\x06proto3')
)
...
_POIDECORATIONPROPERTIES = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SET_RAID_DATA', index=5, number=5,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NEARBY_CARROT_VISIBLE', index=6, number=6,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SET_LOWEST_MOTIVATION', index=7, number=7,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SET_NPC_CLICKED_ACTION', index=8, number=8,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='BEGIN_EXIT', index=9, number=9,
      serialized_options=None,
      type=None),
  ],
