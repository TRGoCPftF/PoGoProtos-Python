...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n-pogoprotos/data/vsseeker/vs_seeker_loot.proto\x12\x18pogoprotos.data.vsseeker\x1a\x35pogoprotos/data/vsseeker/vs_seeker_reward_track.proto\x1a$pogoprotos/inventory/loot_item.proto\"\xa3\x02\n\x0cVsSeekerLoot\x12\x12\n\nrank_level\x18\x01 \x01(\x05\x12=\n\x06reward\x18\x02 \x03(\x0b\x32-.pogoprotos.data.vsseeker.VsSeekerLoot.Reward\x12\x43\n\x0creward_track\x18\x03 \x01(\x0e\x32-.pogoprotos.data.vsseeker.VsSeekerRewardTrack\x1a{\n\x06Reward\x12.\n\x04item\x18\x01 \x01(\x0b\x32\x1e.pogoprotos.inventory.LootItemH\x00\x12\x18\n\x0epokemon_reward\x18\x02 \x01(\x08H\x00\x12\x19\n\x0fitem_loot_table\x18\x03 \x01(\x08H\x00\x42\x0c\n\nRewardTypeb\x06proto3')
  ,
