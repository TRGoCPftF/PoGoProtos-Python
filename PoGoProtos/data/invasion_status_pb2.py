...
# source: pogoprotos/data/invasion_status.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='pogoprotos/data/invasion_status.proto',
...
_INVASIONSTATUS_STATUS = _descriptor.EnumDescriptor(
  name='Status',
  full_name='pogoprotos.data.InvasionStatus.Status',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_INVASIONSTATUS = _descriptor.Descriptor(
  name='InvasionStatus',
  full_name='pogoprotos.data.InvasionStatus',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
InvasionStatus = _reflection.GeneratedProtocolMessageType('InvasionStatus', (_message.Message,), dict(
  ...
  __module__ = 'pogoprotos.data.invasion_status_pb2'
  # @@protoc_insertion_point(class_scope:pogoprotos.data.InvasionStatus)
  ))
