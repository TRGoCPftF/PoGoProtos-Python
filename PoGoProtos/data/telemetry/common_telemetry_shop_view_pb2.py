...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n:pogoprotos/data/telemetry/common_telemetry_shop_view.proto\x12\x19pogoprotos.data.telemetry\"\xa1\x01\n\x17\x43ommonTelemetryShopView\x12\"\n\x1ashopping_page_view_type_id\x18\x01 \x01(\t\x12\x1f\n\x17view_start_timestamp_ms\x18\x02 \x01(\x03\x12\x1d\n\x15view_end_timestamp_ms\x18\x03 \x01(\x03\x12\"\n\x1aroot_store_page_session_id\x18\x04 \x01(\tb\x06proto3')
)
...
_COMMONTELEMETRYSHOPVIEW = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='root_store_page_session_id', full_name='pogoprotos.data.telemetry.CommonTelemetryShopView.root_store_page_session_id', index=3,
