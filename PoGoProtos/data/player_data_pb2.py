...
_PLAYERDATA = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='helpshift_user_id', full_name='pogoprotos.data.PlayerData.helpshift_user_id', index=23,
