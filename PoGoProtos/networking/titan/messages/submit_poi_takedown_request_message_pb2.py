...
# source: pogoprotos/networking/titan/messages/submit_poi_takedown_request_message.proto
...
_SUBMITPOITAKEDOWNREQUESTMESSAGE_POIINVALIDREASON = _descriptor.EnumDescriptor(
  ...
  full_name='pogoprotos.networking.titan.messages.SubmitPoiTakedownRequestMessage.PoiInvalidReason',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_SUBMITPOITAKEDOWNREQUESTMESSAGE = _descriptor.Descriptor(
  ...
  full_name='pogoprotos.networking.titan.messages.SubmitPoiTakedownRequestMessage',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='poi_id', full_name='pogoprotos.networking.titan.messages.SubmitPoiTakedownRequestMessage.poi_id', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='invalid_reason', full_name='pogoprotos.networking.titan.messages.SubmitPoiTakedownRequestMessage.invalid_reason', index=1,
...
SubmitPoiTakedownRequestMessage = _reflection.GeneratedProtocolMessageType('SubmitPoiTakedownRequestMessage', (_message.Message,), dict(
  ...
  __module__ = 'pogoprotos.networking.titan.messages.submit_poi_takedown_request_message_pb2'
  # @@protoc_insertion_point(class_scope:pogoprotos.networking.titan.messages.SubmitPoiTakedownRequestMessage)
  ))
