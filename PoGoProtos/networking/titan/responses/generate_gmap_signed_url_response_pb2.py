...
# source: pogoprotos/networking/titan/responses/generate_gmap_signed_url_response.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='pogoprotos/networking/titan/responses/generate_gmap_signed_url_response.proto',
  package='pogoprotos.networking.titan.responses',
  syntax='proto3',
  serialized_options=None,
  serialized_pb=_b('\nMpogoprotos/networking/titan/responses/generate_gmap_signed_url_response.proto\x12%pogoprotos.networking.titan.responses\"\x93\x02\n\x1dGenerateGmapSignedUrlResponse\x12[\n\x06result\x18\x01 \x01(\x0e\x32K.pogoprotos.networking.titan.responses.GenerateGmapSignedUrlResponse.Result\x12\x12\n\nsigned_url\x18\x02 \x01(\t\"\x80\x01\n\x06Result\x12\t\n\x05UNSET\x10\x00\x12\x0b\n\x07SUCCESS\x10\x01\x12\x1a\n\x16\x45RROR_PLAYER_NOT_VALID\x10\x02\x12\x16\n\x12\x45RROR_RATE_LIMITED\x10\x03\x12\x17\n\x13\x45RROR_MISSING_INPUT\x10\x04\x12\x11\n\rERROR_UNKNOWN\x10\x05\x62\x06proto3')
)
...
_GENERATEGMAPSIGNEDURLRESPONSE_RESULT = _descriptor.EnumDescriptor(
  name='Result',
  full_name='pogoprotos.networking.titan.responses.GenerateGmapSignedUrlResponse.Result',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_GENERATEGMAPSIGNEDURLRESPONSE = _descriptor.Descriptor(
  ...
  full_name='pogoprotos.networking.titan.responses.GenerateGmapSignedUrlResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='result', full_name='pogoprotos.networking.titan.responses.GenerateGmapSignedUrlResponse.result', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='signed_url', full_name='pogoprotos.networking.titan.responses.GenerateGmapSignedUrlResponse.signed_url', index=1,
...
GenerateGmapSignedUrlResponse = _reflection.GeneratedProtocolMessageType('GenerateGmapSignedUrlResponse', (_message.Message,), dict(
  ...
  __module__ = 'pogoprotos.networking.titan.responses.generate_gmap_signed_url_response_pb2'
  # @@protoc_insertion_point(class_scope:pogoprotos.networking.titan.responses.GenerateGmapSignedUrlResponse)
  ))
