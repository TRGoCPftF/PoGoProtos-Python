...
_RESPONSEENVELOPE_SOCIALRESPONSE = _descriptor.Descriptor(
  name='SocialResponse',
  full_name='pogoprotos.networking.envelopes.ResponseEnvelope.SocialResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='type', full_name='pogoprotos.networking.envelopes.ResponseEnvelope.SocialResponse.type', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='response', full_name='pogoprotos.networking.envelopes.ResponseEnvelope.SocialResponse.response', index=1,
      number=2, type=12, cpp_type=9, label=1,
      has_default_value=False, default_value=_b(""),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_RESPONSEENVELOPE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='social_returns', full_name='pogoprotos.networking.envelopes.ResponseEnvelope.social_returns', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='platform_returns', full_name='pogoprotos.networking.envelopes.ResponseEnvelope.platform_returns', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='auth_ticket', full_name='pogoprotos.networking.envelopes.ResponseEnvelope.auth_ticket', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='returns', full_name='pogoprotos.networking.envelopes.ResponseEnvelope.returns', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='error', full_name='pogoprotos.networking.envelopes.ResponseEnvelope.error', index=7,
  ...
  nested_types=[_RESPONSEENVELOPE_PLATFORMRESPONSE, _RESPONSEENVELOPE_SOCIALRESPONSE, ],
  enum_types=[
...
_RESPONSEENVELOPE_SOCIALRESPONSE.fields_by_name['type'].message_type = pogoprotos_dot_networking_dot_social_dot_social__request__pb2._SOCIALREQUEST
_RESPONSEENVELOPE_SOCIALRESPONSE.containing_type = _RESPONSEENVELOPE
_RESPONSEENVELOPE.fields_by_name['status_code'].enum_type = _RESPONSEENVELOPE_STATUSCODE
_RESPONSEENVELOPE.fields_by_name['social_returns'].message_type = _RESPONSEENVELOPE_SOCIALRESPONSE
...
ResponseEnvelope = _reflection.GeneratedProtocolMessageType('ResponseEnvelope', (_message.Message,), dict(
  ...
  SocialResponse = _reflection.GeneratedProtocolMessageType('SocialResponse', (_message.Message,), dict(
    DESCRIPTOR = _RESPONSEENVELOPE_SOCIALRESPONSE,
    __module__ = 'pogoprotos.networking.envelopes.response_envelope_pb2'
    # @@protoc_insertion_point(class_scope:pogoprotos.networking.envelopes.ResponseEnvelope.SocialResponse)
    ))
  ,
...
_sym_db.RegisterMessage(ResponseEnvelope.SocialResponse)
