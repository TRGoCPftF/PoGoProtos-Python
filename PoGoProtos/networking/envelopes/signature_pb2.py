...
_SIGNATURE_UNKNOWNMESSAGE = _descriptor.Descriptor(
  name='UnknownMessage',
  full_name='pogoprotos.networking.envelopes.Signature.UnknownMessage',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_SIGNATURE = _descriptor.Descriptor(
  ...
  nested_types=[_SIGNATURE_LOCATIONFIX, _SIGNATURE_ANDROIDGPSINFO, _SIGNATURE_SENSORINFO, _SIGNATURE_DEVICEINFO, _SIGNATURE_ACTIVITYSTATUS, _SIGNATURE_UNKNOWNMESSAGE, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_SIGNATURE_UNKNOWNMESSAGE.containing_type = _SIGNATURE
_SIGNATURE.fields_by_name['field1'].message_type = _SIGNATURE_UNKNOWNMESSAGE
...
_SIGNATURE.fields_by_name['field6'].message_type = _SIGNATURE_UNKNOWNMESSAGE
...
Signature = _reflection.GeneratedProtocolMessageType('Signature', (_message.Message,), dict(
  ...
  UnknownMessage = _reflection.GeneratedProtocolMessageType('UnknownMessage', (_message.Message,), dict(
    DESCRIPTOR = _SIGNATURE_UNKNOWNMESSAGE,
    __module__ = 'pogoprotos.networking.envelopes.signature_pb2'
    # @@protoc_insertion_point(class_scope:pogoprotos.networking.envelopes.Signature.UnknownMessage)
    ))
  ,
...
_sym_db.RegisterMessage(Signature.UnknownMessage)
