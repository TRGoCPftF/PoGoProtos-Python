...
# source: pogoprotos/networking/platform/responses/get_inventory_response.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='pogoprotos/networking/platform/responses/get_inventory_response.proto',
  package='pogoprotos.networking.platform.responses',
  syntax='proto3',
  serialized_options=None,
  serialized_pb=_b('\nEpogoprotos/networking/platform/responses/get_inventory_response.proto\x12(pogoprotos.networking.platform.responses\x1a*pogoprotos/inventory/inventory_delta.proto\"f\n\x14GetInventoryResponse\x12\x0f\n\x07success\x18\x01 \x01(\x08\x12=\n\x0finventory_delta\x18\x02 \x01(\x0b\x32$.pogoprotos.inventory.InventoryDeltab\x06proto3')
  ,
...
_GETINVENTORYRESPONSE = _descriptor.Descriptor(
  ...
  full_name='pogoprotos.networking.platform.responses.GetInventoryResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='success', full_name='pogoprotos.networking.platform.responses.GetInventoryResponse.success', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='inventory_delta', full_name='pogoprotos.networking.platform.responses.GetInventoryResponse.inventory_delta', index=1,
...
GetInventoryResponse = _reflection.GeneratedProtocolMessageType('GetInventoryResponse', (_message.Message,), dict(
  ...
  __module__ = 'pogoprotos.networking.platform.responses.get_inventory_response_pb2'
  # @@protoc_insertion_point(class_scope:pogoprotos.networking.platform.responses.GetInventoryResponse)
  ))
