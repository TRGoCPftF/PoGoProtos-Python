...
# source: pogoprotos/networking/platform/responses/submit_poi_takedown_request_response.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='pogoprotos/networking/platform/responses/submit_poi_takedown_request_response.proto',
  package='pogoprotos.networking.platform.responses',
  syntax='proto3',
  serialized_options=None,
  serialized_pb=_b('\nSpogoprotos/networking/platform/responses/submit_poi_takedown_request_response.proto\x12(pogoprotos.networking.platform.responses\"\x9b\x02\n SubmitPoiTakedownRequestResponse\x12\x61\n\x06status\x18\x01 \x01(\x0e\x32Q.pogoprotos.networking.platform.responses.SubmitPoiTakedownRequestResponse.Status\"\x93\x01\n\x06Status\x12\x16\n\x12STATUS_UNSPECIFIED\x10\x00\x12\x0b\n\x07SUCCESS\x10\x01\x12\x12\n\x0eINTERNAL_ERROR\x10\x02\x12\x1f\n\x1bTOO_MANY_RECENT_SUBMISSIONS\x10\x03\x12\t\n\x05MINOR\x10\x04\x12\x11\n\rNOT_AVAILABLE\x10\x05\x12\x11\n\rINVALID_INPUT\x10\x06\x62\x06proto3')
)
...
_SUBMITPOITAKEDOWNREQUESTRESPONSE_STATUS = _descriptor.EnumDescriptor(
  name='Status',
  full_name='pogoprotos.networking.platform.responses.SubmitPoiTakedownRequestResponse.Status',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_SUBMITPOITAKEDOWNREQUESTRESPONSE = _descriptor.Descriptor(
  ...
  full_name='pogoprotos.networking.platform.responses.SubmitPoiTakedownRequestResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='status', full_name='pogoprotos.networking.platform.responses.SubmitPoiTakedownRequestResponse.status', index=0,
...
SubmitPoiTakedownRequestResponse = _reflection.GeneratedProtocolMessageType('SubmitPoiTakedownRequestResponse', (_message.Message,), dict(
  ...
  __module__ = 'pogoprotos.networking.platform.responses.submit_poi_takedown_request_response_pb2'
  # @@protoc_insertion_point(class_scope:pogoprotos.networking.platform.responses.SubmitPoiTakedownRequestResponse)
  ))
