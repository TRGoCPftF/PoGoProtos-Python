...
# source: pogoprotos/networking/platform/responses/redeem_apple_receipt_response.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='pogoprotos/networking/platform/responses/redeem_apple_receipt_response.proto',
  package='pogoprotos.networking.platform.responses',
  syntax='proto3',
  serialized_options=None,
  serialized_pb=_b('\nLpogoprotos/networking/platform/responses/redeem_apple_receipt_response.proto\x12(pogoprotos.networking.platform.responses\"s\n\x1aRedeemAppleReceiptResponse\x12&\n\x1eprovisioned_transaction_tokens\x18\x01 \x03(\t\"-\n\x06Status\x12\t\n\x05UNSET\x10\x00\x12\x0b\n\x07SUCCESS\x10\x01\x12\x0b\n\x07\x46\x41ILURE\x10\x02\x62\x06proto3')
)
...
_REDEEMAPPLERECEIPTRESPONSE_STATUS = _descriptor.EnumDescriptor(
  name='Status',
  full_name='pogoprotos.networking.platform.responses.RedeemAppleReceiptResponse.Status',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_REDEEMAPPLERECEIPTRESPONSE = _descriptor.Descriptor(
  ...
  full_name='pogoprotos.networking.platform.responses.RedeemAppleReceiptResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='provisioned_transaction_tokens', full_name='pogoprotos.networking.platform.responses.RedeemAppleReceiptResponse.provisioned_transaction_tokens', index=0,
...
RedeemAppleReceiptResponse = _reflection.GeneratedProtocolMessageType('RedeemAppleReceiptResponse', (_message.Message,), dict(
  ...
  __module__ = 'pogoprotos.networking.platform.responses.redeem_apple_receipt_response_pb2'
  # @@protoc_insertion_point(class_scope:pogoprotos.networking.platform.responses.RedeemAppleReceiptResponse)
  ))
