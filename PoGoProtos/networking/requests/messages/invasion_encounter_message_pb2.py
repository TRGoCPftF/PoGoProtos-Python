...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\nHpogoprotos/networking/requests/messages/invasion_encounter_message.proto\x12\'pogoprotos.networking.requests.messages\x1a%pogoprotos/data/incident_lookup.proto\"[\n\x11InvasionEncounter\x12\x38\n\x0fincident_lookup\x18\x01 \x01(\x0b\x32\x1f.pogoprotos.data.IncidentLookup\x12\x0c\n\x04step\x18\x02 \x01(\x05\x62\x06proto3')
  ,
...
_INVASIONENCOUNTER.fields_by_name['incident_lookup'].message_type = pogoprotos_dot_data_dot_incident__lookup__pb2._INCIDENTLOOKUP
