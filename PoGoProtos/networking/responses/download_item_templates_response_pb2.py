...
_DOWNLOADITEMTEMPLATESRESPONSE_ITEMTEMPLATE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='combat_competitive_season_settings', full_name='pogoprotos.networking.responses.DownloadItemTemplatesResponse.ItemTemplate.combat_competitive_season_settings', index=45,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='combat_ranking_proto_settings', full_name='pogoprotos.networking.responses.DownloadItemTemplatesResponse.ItemTemplate.combat_ranking_proto_settings', index=46,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='combat_type', full_name='pogoprotos.networking.responses.DownloadItemTemplatesResponse.ItemTemplate.combat_type', index=47,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='vs_seeker_client_settings', full_name='pogoprotos.networking.responses.DownloadItemTemplatesResponse.ItemTemplate.vs_seeker_client_settings', index=48,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='limited_purchase_sku_settings', full_name='pogoprotos.networking.responses.DownloadItemTemplatesResponse.ItemTemplate.limited_purchase_sku_settings', index=49,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='pokestop_invasion_availability_settings', full_name='pogoprotos.networking.responses.DownloadItemTemplatesResponse.ItemTemplate.pokestop_invasion_availability_settings', index=50,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='vs_seeker_loot_proto', full_name='pogoprotos.networking.responses.DownloadItemTemplatesResponse.ItemTemplate.vs_seeker_loot_proto', index=51,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='vs_seeker_pokemon_rewards', full_name='pogoprotos.networking.responses.DownloadItemTemplatesResponse.ItemTemplate.vs_seeker_pokemon_rewards', index=52,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='battle_hub_order_settings', full_name='pogoprotos.networking.responses.DownloadItemTemplatesResponse.ItemTemplate.battle_hub_order_settings', index=53,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='battle_hub_badge_settings', full_name='pogoprotos.networking.responses.DownloadItemTemplatesResponse.ItemTemplate.battle_hub_badge_settings', index=54,
...
_DOWNLOADITEMTEMPLATESRESPONSE_ITEMTEMPLATE.fields_by_name['combat_competitive_season_settings'].message_type = pogoprotos_dot_settings_dot_master_dot_combat__competitive__season__settings__pb2._COMBATCOMPETITIVESEASONSETTINGS
_DOWNLOADITEMTEMPLATESRESPONSE_ITEMTEMPLATE.fields_by_name['combat_ranking_proto_settings'].message_type = pogoprotos_dot_settings_dot_master_dot_combat__ranking__settings__pb2._COMBATRANKINGSETTINGS
...
_DOWNLOADITEMTEMPLATESRESPONSE_ITEMTEMPLATE.fields_by_name['vs_seeker_client_settings'].message_type = pogoprotos_dot_settings_dot_master_dot_vs__seeker__client__settings__pb2._VSSEEKERCLIENTSETTINGS
...
_DOWNLOADITEMTEMPLATESRESPONSE_ITEMTEMPLATE.fields_by_name['vs_seeker_loot_proto'].message_type = pogoprotos_dot_data_dot_vsseeker_dot_vs__seeker__loot__pb2._VSSEEKERLOOT
_DOWNLOADITEMTEMPLATESRESPONSE_ITEMTEMPLATE.fields_by_name['vs_seeker_pokemon_rewards'].message_type = pogoprotos_dot_data_dot_vsseeker_dot_vs__seeker__pokemon__rewards__pb2._VSSEEKERPOKEMONREWARDS
_DOWNLOADITEMTEMPLATESRESPONSE_ITEMTEMPLATE.fields_by_name['battle_hub_order_settings'].message_type = pogoprotos_dot_settings_dot_master_dot_battle__hub__order__settings__pb2._BATTLEHUBORDERSETTINGS
_DOWNLOADITEMTEMPLATESRESPONSE_ITEMTEMPLATE.fields_by_name['battle_hub_badge_settings'].message_type = pogoprotos_dot_settings_dot_master_dot_battle__hub__badge__settings__pb2._BATTLEHUBBADGESETTINGS
