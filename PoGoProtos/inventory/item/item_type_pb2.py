...
_ITEMTYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ITEM_TYPE_INCIDENT_TICKET', index=20, number=22,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ITEM_TYPE_GLOBAL_EVENT_TICKET', index=21, number=23,
      serialized_options=None,
      type=None),
  ],
